	...
	if (list.length) {
		...
		for (var i = 0; i < list.length; i += 3) {
			var e = $('<div class="card"><a class="image" href="#' + common.rootDir + "/" + list[i] + '">' +
				...
				'</a><div class="content"><a'+' href="#' + common.rootDir + "/" + list[i]+'" class="header">' + list[i+1] + '<span data-tooltip="This webapp is configured incorrectly!" data-delay="5000" data-position="top left" data-variation="tiny">&nbsp;<i class="warning icon"></i></span>' + '</a></div></div>');
